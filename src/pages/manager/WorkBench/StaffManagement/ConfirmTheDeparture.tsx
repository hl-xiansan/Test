...
import {Image, Modal, StyleSheet, Switch, Text, TouchableHighlight, TouchableOpacity, View,} from 'react-native'
...
export default class ConfirmTheDeparturePage extends Component<Props, State> {
  ...
  async applyForJob() {
    ...
    try {
      ...
      await Api.put(`/labor/staff/worker/${this.props.route.params.id}/out`, data)
      Portal.remove(key)
      this.loading = false
        ...
        <View style={styles.box}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <Text style={styles.modalText}>离职成功！</Text>
                <TouchableHighlight
                  style={{
          ...
          <View style={styles.bottomBtns}>
            <TouchableOpacity activeOpacity={0.5} onPress={this.applyForJob.bind(this)}>
              <Text style={styles.btn}>确认离职</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Provider>
