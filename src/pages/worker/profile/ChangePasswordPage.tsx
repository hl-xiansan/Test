...
export default class ChangePasswordPage extends Component<Props, State> {
                ...
                <SafeAreaView style={styles.container}>
                    ...
                    <View style={styles.changeInfoContent}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(value) => {this.changeValue('oldPassword', value)}}
                            returnKeyType="done"
                    ...
                    <View style={styles.changeInfoContent}>
                        ...
                        <TextInput
                            style={styles.infoText}
                            onChangeText={(value) => {this.changeValue('passwordAgain', value)}}
                            returnKeyType="done"
                            secureTextEntry={true}
